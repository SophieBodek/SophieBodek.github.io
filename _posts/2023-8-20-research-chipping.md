...
![Photo of Sophie standing in lab.](/images/big chart_v4.pdf)
*Progression of particle breakdown according to material parameters and approximate number of impacts; Ni D 0 indicates the initial shape of the particle. The material parameters of each particle type are indicated using VCM, average ultimate strength (u) and modified Young’s modulus (Y ) as measured through Instron compression tests, and average brittle attrition number (Ab). Also shown is particle density (s), which does not vary systematically with material strength. Mechanically strong particles achieved highly rounded shapes over thousands of rotations, while mechanically weak particles quickly fragmented into irregular shapes over 10–20 impacts. Intermediate particles exhibited both behaviors.*

![Photo of Sophie standing in lab.](/images/bodek_sophie_55675942_purm.jpg)
